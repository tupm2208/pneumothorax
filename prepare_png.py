...
def argparser():
	...
	parser.add_argument('-train_path', default='datasets/train/', type=str, nargs='?', help='directory with train')
	parser.add_argument('-test_path', default='datasets/test/', type=str, nargs='?', help='directory with test')
	parser.add_argument('-rle_path', default='datasets/train-rle.csv', type=str, nargs='?', help='path for rle csv file')
